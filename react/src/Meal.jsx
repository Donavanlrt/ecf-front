      ...
      <div className="w-full sm:w-1/2 md:w-1/3 xl:w-1/4 px-6 mt-10">
        <div className="group">
          <div className="relative">
            <img className="h-64 w-full object-cover rounded-t" src={this.props.meal.imageSrc} alt={this.props.meal.title} />
            ...
            <div className="flex items-end absolute bottom-3 left-3 bg-gray-100 rounded-2xl px-5 py-2">
              <div className="inline-flex items-end">
                ...
                <span className="text-sm mr-1 font-bold text-gray-800 leading-none">{this.props.meal.rating}</span>
              </div>
              <span className="text-xs text-gray-500 font-medium leading-none"> ({this.props.meal.reviews})</span>
            </div>
          ...
          <div className="p-4 bg-slate-100 rounded-b">
            <h2 className="text-lg font-semibold group-hover:text-[#6415ff]">{this.props.meal.title}</h2>
            <p className="text-sm font-medium text-slate-500 mt-1">{this.props.meal.content}</p>
            <p className="mt-4 font-bold text-xl">{this.props.meal.price}</p>
          </div>
        </div>
      </div>
    )
